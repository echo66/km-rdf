...
svm_model(TrainData, TrainSet):-
	...
	At = [stringAt('song'), numAt('C0mean'), numAt('C1mean'), numAt('C2mean'), numAt('C3mean'), numAt('C4mean'), numAt('C5mean'), numAt('C6mean'), numAt('C7mean'), numAt('C8mean'), numAt('C9mean'), numAt('C10mean'), numAt('C11mean'), numAt('C12mean'), numAt('C13mean'), numAt('C14mean'), numAt('C15mean'), numAt('C16mean'), numAt('C17mean'), numAt('C18mean'), numAt('C19mean'), numAt('C0var'), numAt('C1var'), numAt('C2var'), numAt('C3var'), numAt('C4var'), numAt('C5var'), numAt('C6var'), numAt('C7var'), numAt('C8var'), numAt('C9var'), numAt('C10var'), numAt('C11var'), numAt('C12var'), numAt('C13var'), numAt('C14var'), numAt('C15var'),numAt('C16var'), numAt('C17var'), numAt('C18var'), numAt('C19var'), stringAt('tag')],
	SetID = 'genre',	
	%may need some checks about the class we set here
	create_classifSet(SetID, At, 41),
...
:-Song = '/home/david/Repository/Test.mp3',
	...
	blob_list(D1, L1),
	blob_list(D2, L2),
	svm_model([[Song, L1, L2, 'britpop']], P).
